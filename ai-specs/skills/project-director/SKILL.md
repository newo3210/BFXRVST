...
2. Ask **incómodas pero concretas** until scope is clear:
   ...
   - **If persistence is involved:** run Data Architecture Discovery (`docs/data-architecture-discovery.md`) — query patterns, ACID vs eventual, scale, relational vs document — before any schema in `design.md`
